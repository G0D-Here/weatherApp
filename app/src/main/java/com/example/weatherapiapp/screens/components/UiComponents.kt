        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(text = wind.deg.toString(), color = Color.White, fontSize = 8.sp, fontWeight = FontWeight.Bold)
                }
                Column(
                    Modifier.padding(10.dp),
                    horizontalAlignment = Alignment.CenterHorizontally
                    ...
                    Text(text = wind.gust.toString(), color = Color.White, fontSize = 8.sp, fontWeight = FontWeight.Bold)
                }
            }
        }
    }
...
fun SearchBar(weather: WeatherResponse) {
    Card(
        ...
        Row(
            ...
            Icon(imageVector = Icons.Default.Search, contentDescription = null,Modifier.padding(start = 5.dp),)
            Text(
